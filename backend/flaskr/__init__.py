...
def create_app(test_config=None):
  ...
  '''
    ...
    def get_all_questions():
        ...
        formatted_all_question = [question.format()
  ...
  '''
    ...
    def insert_new_question():
        ...
        try:
            my_question = Question(question=new_question, answer=new_answer,
  ...
  '''
    ...
    def search_question():
        ...
        search_results = Question.query.filter(
            Question.question.ilike('%'+serach_term+'%')).all()
  ...
  '''
    ...
    def get_category_all_questions(cat_id):
        ...
        formatted_all_question = [question.format()
                                  for question in mycategory_questions]
        page = request.args.get('page', 1, type=int)
        start = (page - 1) * QUESTIONS_PER_PAGE
        end = start + QUESTIONS_PER_PAGE
